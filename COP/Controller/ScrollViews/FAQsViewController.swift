...
class FAQsViewController: UIViewController{
    ...
    The Constable On Patrol (COP) App is an Android and iOS application developed in collaboration with the Delhi Police to enhance foot patrolling effectiveness. It features real-time constable tracking, a dynamic crime map, jurisdiction-based crime monitoring, and public feedback mechanisms.
    ...
    You can download the COP App from the link provided by the Developers. Search for "Constable On Patrol" and follow the instructions to install it on your Android or iOS device.

    5. What are the system requirements for the COP App?
    The COP App requires an Android device running Android version 5.0 (Lollipop) and iOS version 15.0 or higher with an active internet connection for real-time features.
...
"""
        ...
        let largefont = UIFont.boldSystemFont(ofSize: 18)
